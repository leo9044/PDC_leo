...
# ════════════════════════════════════════════════════════════
# HomeScreenApp 실행 스크립트 (Direct to Weston - wayland-0)
...
export VSOMEIP_CONFIGURATION="${SCRIPT_DIR}/vsomeip_homescreen.json"
export COMMONAPI_CONFIG="${SCRIPT_DIR}/commonapi_homescreen.ini"
...
# IVI Surface ID (HomeScreenApp = 4000)
export QT_IVI_SURFACE_ID=4000
